    ...
    <div id="prod_wrapper">
        <div id="panes">
            <c:forEach var="product" items="${newProducts}">
                <div>
                    <img src="${initParam.imgProductPath}${product.getImage()}" width="379" height="225" alt="">
        ...
        <div id="prod_nav">
            <ul>
                ...
                <c:forEach var="product" items="${newProducts}">
                    <li>
                        <a href="#${countProduct}">
                            <img src="${initParam.imgProductPath}${product.getImage()}" width="75" height="75" alt="">
        ...
        <c:if test="${category.categoryId == 4}" >
            <div class="one-fourth last">
                ...
                <a href="<c:url value='category?${category.categoryId}'/>">
                    <img src="${initParam.imgProductPath}${category.getImage()}" width="217" height="145" alt="">
                </a>
            </div>
        </c:if>
        <c:if test="${category.categoryId < 4}">
